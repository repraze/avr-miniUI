...
void main() {
	...
	default_UI.menu_padding = 1;
	default_UI.button_background = WHITE;
	default_UI.button_selected_background = GREEN;
	
	display_menu_at("test;tes2;tes3",1, 10,10);
}

void init_miniUI(){
	default_UI.menu_background 				= WHITE;
	default_UI.menu_padding 				= 2;
...
int display_menu_at(char *menu, int choice, int x,int y){
	int padding = default_UI.menu_padding;
